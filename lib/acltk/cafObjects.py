...
class cafBlock:
    def __init__(self, expr):
        assert isinstance(expr, (ACLRule, cafBlock, cafOp)), "unexpected type {} or class {}".format(
            type(expr), expr.__class__.__qualname__
        )
        self.expr = expr
    ...
    def run(self, rules, verbose=False):
        assert isinstance(rules, (ACLRules, cafOp, cafBlock)), "unexpected type {} or class {}".format(
            type(rules), rules.__class__.__qualname__
        )
...
class cafOp:
    def __init__(self, a, b):
        assert isinstance(a, (cafBlock, cafOp, ACLRule)), "unexpected type {} or class {}".format(
            type(a), a.__class__.__qualname__
        )
        assert isinstance(b, (cafBlock, cafOp, ACLRule)), "unexpected type {} or class {}".format(
            type(b), b.__class__.__qualname__
        )
    ...
    def run(self, rules, verbose=False):
        assert isinstance(rules, (ACLRules, cafOp, cafBlock, NATObject)), "unexpected type {} or class {}".format(
            type(rules), rules.__class__.__qualname__
        )
